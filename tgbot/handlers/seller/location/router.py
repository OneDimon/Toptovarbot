...
location_router.callback_query.register(Location.back_location, lambda c: c.data == 'back_location')
location_router.callback_query.register(Name().start_of_step, lambda c: c.data == 'location')
...
location_router.message.register(Place().get_answer, StateLocation.place)
location_router.callback_query.register(Place().get_answer, StateLocation.place)
...
location_router.message.register(Photo().get_answer, StateLocation.photo)
location_router.callback_query.register(Photo().get_answer, StateLocation.photo)
