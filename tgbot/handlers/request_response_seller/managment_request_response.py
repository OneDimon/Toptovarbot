...
respons_obj = Response_seller()


class Request_response_manager:
    ...
    def initRouter():
        ...
        router_request_response.callback_query.register(Request_response_manager.responseButtonClik, lambda c: c.data == 'response_button')
