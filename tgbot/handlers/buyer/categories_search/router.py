...
categorias_search_router.error.register(CustomLogger('logs/error_logs/buyer/categories_search.log').loging_hanlder_errors, StateFilter(StateCategoriesSearch))
