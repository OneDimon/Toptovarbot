<?php /* Smarty version Smarty-3.1.14, created on 2024-05-09 09:44:33
         compiled from "C:\OSPanel\domains\tovarka\wa-apps\site\themes\default\index.html" */ ?>
<?php /*%%SmartyHeaderCode:891798373663c70d1822497-92092380%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd42be28fd6bd372c2a8a64f53b79fe298a0f2111' => 
    array (
      0 => 'C:\\OSPanel\\domains\\tovarka\\wa-apps\\site\\themes\\default\\index.html',
      1 => 1702452397,
      2 => 'file',
    ),
    '9eb1dc1ebdfc1bee1fcc0e5932f692185e03e053' => 
    array (
      0 => 'C:\\OSPanel\\domains\\tovarka\\wa-apps\\site\\themes\\default\\admin-sidebar.html',
      1 => 1678097371,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '891798373663c70d1822497-92092380',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_663c70d3644ce9_76835188',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_663c70d3644ce9_76835188')) {function content_663c70d3644ce9_76835188($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\OSPanel\\domains\\tovarka\\wa-system\\vendors\\smarty3\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_wa_datetime')) include 'C:\\OSPanel\\domains\\tovarka\\wa-system/vendors/smarty-plugins\\modifier.wa_datetime.php';
?><!DOCTYPE html>
<?php $_smarty_tpl->tpl_vars['html_class_array'] = new Smarty_variable(array(), null, 0);?><?php $_smarty_tpl->tpl_vars['_color_scheme_class'] = new Smarty_variable(('color_scheme_').(str_replace('img/themesettings/','',str_replace('.png','',$_smarty_tpl->tpl_vars['theme_settings']->value['color_scheme']))), null, 0);?><?php $_smarty_tpl->tpl_vars['_color_scheme'] = new Smarty_variable(str_replace('img/themesettings/','',str_replace('.png','',$_smarty_tpl->tpl_vars['theme_settings']->value['color_scheme'])), null, 0);?><?php $_smarty_tpl->tpl_vars['_scheme_colors'] = new Smarty_variable(array('white'=>'#fff','yellow'=>'#fb0','green'=>'#6fb541','blue'=>'#4e81cc','purple'=>'#9a81b3','gray'=>'#9c9c9c','pink'=>'#e871b1','cyan'=>'#3ac1bf','lime'=>'#b5ce10','red'=>'#cf2219'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_scheme']){?><?php $_smarty_tpl->createLocalArrayVariable('html_class_array', null, 0);
...
$_smarty_tpl->tpl_vars['html_class_array']->value[] = 'my';?><?php }?><?php if ($_smarty_tpl->tpl_vars['wa']->value->shop){?><?php $_smarty_tpl->tpl_vars['_cart_url'] = new Smarty_variable($_smarty_tpl->tpl_vars['wa']->value->getUrl('shop/frontend/order'), null, 0);?><?php }?><?php $_smarty_tpl->tpl_vars['_is_order_page'] = new Smarty_variable($_smarty_tpl->tpl_vars['wa']->value->globals("isOrderPage"), null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['_is_order_page']->value)){?><?php $_smarty_tpl->createLocalArrayVariable('html_class_array', null, 0);
...
">
    <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor']){?>
        <meta name="theme-color" content="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor'], ENT_QUOTES, 'UTF-8', true);?>
">
    <?php }?>
...
" rel="stylesheet" type="text/css">
    ...
    <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['font_family'])&&($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']!='Trebuchet MS'||$_smarty_tpl->tpl_vars['theme_settings']->value['font_family']!='Verdana'||$_smarty_tpl->tpl_vars['theme_settings']->value['font_family']!='Georgia, Times')){?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='Fira Sans'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('Fira+Sans:400,500,700,400italic,500italic,700italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='Open Sans'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('Open+Sans:400,700,700italic,400italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='PT Sans'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('PT+Sans:400,700,700italic,400italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='PT Serif'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('PT+Serif:400,700,700italic,400italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='PT Sans Caption'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('PT+Sans+Caption:400,700|PT+Serif:400,700,700italic,400italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='Roboto'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('Roboto:400,700,700italic,400italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='Lora'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('Lora:400,700,700italic,400italic', null, 0);?><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']=='Ubuntu'){?><?php $_smarty_tpl->tpl_vars['_real_font_name'] = new Smarty_variable('Ubuntu:400,700,700italic,400italic', null, 0);?><?php }?>
...
"></script>
    ...
    <style>
        html {
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_family']){?>
            --font-family: '<?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['font_family'];?>
', sans-serif;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['font_size']){?>
            --font-size: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['font_size'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_text']){?>
            --text-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_text'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_hint']){?>
            --hint-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_hint'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_links']){?>
            --link-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_links'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_links_hover']){?>
            --link-hover-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_links_hover'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_links_visited']){?>
            --link-visited-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_links_visited'];?>
;
        <?php }?>
        <?php if (strstr($_smarty_tpl->tpl_vars['theme_settings']->value['header_scheme'],'white.')){?>
            --header-bg-color:                  #fff;
        ...
        <?php }?>
        <?php if (strstr($_smarty_tpl->tpl_vars['theme_settings']->value['header_scheme'],'whiteandgray.')){?>
            --header-bg-color: #eee;
            --header-link-color:               var(--gray1);
            --header-link-hover-color:         var(--black);
            --header-apps-link-color:          var(--gray3);
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor']){?>
            --header-bg-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor_links']){?>
            --header-link-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor_links'];?>
;
        <?php }?>

        <?php if (empty($_smarty_tpl->tpl_vars['theme_settings']->value['color_custom'])){?>
            --header-menu-bg-color: <?php echo $_smarty_tpl->tpl_vars['_scheme_colors']->value[$_smarty_tpl->tpl_vars['_color_scheme']->value];?>
;
            <?php if ($_smarty_tpl->tpl_vars['_color_scheme']->value!='white'&&$_smarty_tpl->tpl_vars['_color_scheme']->value!='yellow'){?>
                --header-menu-pages-link-color:    var(--white)
            <?php }?>
        <?php }?>

        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_custom']){?>
            --header-menu-bg-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_custom'];?>
;
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['color_custom_links']){?>
            --header-menu-link-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['color_custom_links'];?>
;
        <?php }?>
...
<body>
    <header class="globalheader"<?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['header_custom_image']){?> style="background-image: url('<?php echo ($_smarty_tpl->tpl_vars['wa_theme_url']->value).($_smarty_tpl->tpl_vars['theme_settings']->value['header_custom_image']);?>
');"<?php }?>>

        <?php if (count($_smarty_tpl->tpl_vars['wa']->value->apps())>0||$_smarty_tpl->tpl_vars['wa']->value->isAuthEnabled()){?>

            <!-- GLOBAL NAVIGATION -->
            <div id="globalnav"<?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor']){?> style="background-color: <?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['header_customcolor'];?>
;"<?php }?>>
                <div class="container">
...
" id="logo" />
                        ...
                        <nav class="wa-flex wa-flex-fill overflow-hidden<?php if (!empty($_smarty_tpl->tpl_vars['_hide_cart']->value)&&!$_smarty_tpl->tpl_vars['wa']->value->isAuthEnabled()){?> wa-mr-0<?php }?>">
...
"><?php echo $_smarty_tpl->tpl_vars['a']->value['name'];?>
                        ...
                        <div class="wa-flex wa-ml-auto wa-mr-0">
                            <?php if ($_smarty_tpl->tpl_vars['wa']->value->shop&&(!method_exists($_smarty_tpl->tpl_vars['wa']->value->shop,'hasRoutes')||$_smarty_tpl->tpl_vars['wa']->value->shop->hasRoutes())&&!empty($_smarty_tpl->tpl_vars['theme_settings']->value['show_cart'])&&empty($_smarty_tpl->tpl_vars['_hide_cart']->value)){?>
                                ...
                                <div id="cart" class="cart wa-flex<?php if (!$_smarty_tpl->tpl_vars['cart_total']->value){?> empty<?php }?>">
                                    <div class="container">
...
" class="cart-summary">
                                        ...
                                        <strong class="s-badge s-badge-rounded cart-total"><?php echo wa_currency_html($_smarty_tpl->tpl_vars['cart_total']->value,$_smarty_tpl->tpl_vars['wa']->value->shop->currency());?>
</strong>
                                    </a>
                                    <div id="cart-content">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['wa']->value->isAuthEnabled()){?>
                                <!-- user auth -->
                                <ul class="auth align-items-center space-05" id="js-header-auth-wrapper"><?php if ($_smarty_tpl->tpl_vars['wa']->value->user()->isAuth()){?><?php if ($_smarty_tpl->tpl_vars['wa']->value->myUrl()){?><li><a href="<?php echo $_smarty_tpl->tpl_vars['wa']->value->myUrl();?>
"><i class="icon16 userpic20" style="background-image: url('<?php echo $_smarty_tpl->tpl_vars['wa']->value->user()->getPhoto2x(20);?>
');"></i></a></li><?php }else{ ?><li><strong><?php echo (($tmp = @$_smarty_tpl->tpl_vars['wa']->value->user('firstname'))===null||$tmp==='' ? 'Личный кабинет' : $tmp);?>
</strong></li><?php }?><li><a href="?logout" class="auth-logout">Выйти</a></li><?php }else{ ?><li><a href="<?php echo $_smarty_tpl->tpl_vars['wa']->value->loginUrl();?>
" class="not-visited text-white"><svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin"><use xlink:href="#img-person"></use></svg></a></li><li><a href="<?php echo $_smarty_tpl->tpl_vars['wa']->value->loginUrl();?>
" class="not-visited text-gray">Вход</a></li><?php }?></ul>
                            <?php }?>
                        </div>
        ...
        <?php if (empty($_smarty_tpl->tpl_vars['_is_order_page']->value)){?>
        <!-- APP NAVIGATION -->
        <div class="container appnav wa-flex justify-content-between align-items-center" id="header-container"<?php if (strstr($_smarty_tpl->tpl_vars['theme_settings']->value['header_scheme'],'andgray')){?> style="border-top: 1px solid transparent;"<?php }?>>
                ...
                <div class="container">
                    <div class="s-subscribe-section row cols1-mobile" id="js-subscribe-section">
                        <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['footer_subscribe_form_title'])){?>
                            <p class="col w5 s-subscribe-section--title wa-mb-4 wa-pl-4"><?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['footer_subscribe_form_title'];?>
</p>
                        <?php }?>
                        <form class="col w7">
                            <div class="row">
...
"
                    ...
                    <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['footer_subscribe_personal_data'])){?>
                        <div class="s-subscribe-personal-data wa-mt-24"><?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['footer_subscribe_personal_data'];?>
</div>
                    <?php }?>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row gap20 cols4 cols1-mobile cols2-tablet">
                ...
                <div class="footer-block contact-us col w3">
                    <div class="social">
                        <?php if ($_smarty_tpl->tpl_vars['wa']->value->blog&&$_smarty_tpl->tpl_vars['rss']->value){?>
                            <a class="wa-mb-0" href="<?php echo $_smarty_tpl->tpl_vars['rss']->value;?>
" title="RSS">
                                <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin">
                        ...
                        <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['facebook'])){?>
                            <a class="wa-mb-0" href="<?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['facebook'];?>
" title="Фейсбук">
                                <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin">
                        ...
                        <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['twitter'])){?>
                            <a class="wa-mb-0" href="<?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['twitter'];?>
" title="Твиттер">
                                <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin">
                        ...
                        <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['vk'])){?>
                            <a class="wa-mb-0" href="<?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['vk'];?>
" title="ВКонтакте">
                                <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin">
                        ...
                        <?php }?>
                        <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['instagram'])){?>
                            <a class="wa-mb-0" href="<?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['instagram'];?>
" title="Инстаграм">
                                <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin">
                        ...
                        <?php }?>
                        <?php if (!empty($_smarty_tpl->tpl_vars['theme_settings']->value['youtube'])){?>
                            <a class="wa-mb-0" href="<?php echo $_smarty_tpl->tpl_vars['theme_settings']->value['youtube'];?>
" title="Youtube">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['wa']->value->shop){?>
                        <p class="wa-flex align-items-center wa-mb-8">Телефон: <a class="wa-ml-4 wa-mb-0" href="tel:<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['wa']->value->shop->settings('phone'),array(' ','(',')','-'),'');?>
"><?php echo $_smarty_tpl->tpl_vars['wa']->value->shop->settings('phone');?>
</a></p>
                        <p class="wa-flex align-items-center wa-mb-16">Email: <a class="wa-ml-4 wa-mb-0" href="mailto:<?php echo $_smarty_tpl->tpl_vars['wa']->value->shop->settings('email');?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("admin-sidebar.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '891798373663c70d1822497-92092380');
content_663c70d2e9b3e6_48152851($_smarty_tpl);
...
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2024-05-09 09:44:34
         compiled from "C:\OSPanel\domains\tovarka\wa-apps\site\themes\default\admin-sidebar.html" */ ?>
<?php if ($_valid && !is_callable('content_663c70d2e9b3e6_48152851')) {function content_663c70d2e9b3e6_48152851($_smarty_tpl) {?>
